...
sep_len_index = 1;
% sep_wid_index = 2; % Training without the sepal width feature
pet_len_index = 3;
pet_wid_index = 4;
...
confusion_test.Title = 'Confusion matrix for test set,, with three features';
...
confusion_training.Title = 'Confusion matrix for training set, with three features';
confusion_training.RowSummary = 'row-normalized';
confusion_training.ColumnSummary = 'column-normalized';
% print('confusion_m_2a','-depsc')
