...
x1_training = x1all(1:N,pet_len_index:pet_wid_index);   % Training set for class 1   
x2_training = x2all(1:N,pet_len_index:pet_wid_index);   % Training set for class 2
x3_training = x3all(1:N,pet_len_index:pet_wid_index);   % Training set for class 3

x1_testing = x1all(N+1:end,pet_len_index:pet_wid_index);   % Test set for class 1   
x2_testing = x2all(N+1:end,pet_len_index:pet_wid_index);   % Test set for class 2
x3_testing = x3all(N+1:end,pet_len_index:pet_wid_index);   % Test set for class 3
...
confusion_test.Title = 'Confusion matrix for test set,, with two features';
...
confusion_training.Title = 'Confusion matrix for training set, with two features';
confusion_training.RowSummary = 'row-normalized';
confusion_training.ColumnSummary = 'column-normalized';
%print('confusion_m_2b','-depsc')
