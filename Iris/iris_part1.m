...
% Testing
n_test = M-N;
Xtest = [x_testing'; ones(1, size(x_testing,1))];                   % Testing data
Ttest = [repelem(1,n_test), repelem(2,n_test), repelem(3,n_test)];  % True solutions
[~,classified_classes] = max(W*Xtest);                              % Classes given after testing
